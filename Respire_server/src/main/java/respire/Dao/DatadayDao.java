...
public interface DatadayDao extends PagingAndSortingRepository<Datanow,DatanowPK> {
	...
	public List<DataModel> getbyweek1(String userid, Pageable pageable);
	default List<DataModel> getbyweek(String userid){
	...
	public List<DataModel> getbymonth(String userid);
	...
	public List<DataModel> getbyyear(String userid);
